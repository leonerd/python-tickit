...
__all__ = ['TICKIT_EV_CHANGE', 'TickitRect', 'TICKIT_EV_MOUSE',
           ...
           'TICKIT_TERMCTL_CURSORSHAPE', 'TICKIT_PEN_ITALIC',
           ...
           'TICKIT_EV_UNBIND', 'TICKIT_PEN_UNDER',
           'TICKIT_PENTYPE_COLOUR', 'TickitPenAttrType',
           'TICKIT_MOUSEEV_WHEEL', 'TickitEvent', 'TICKIT_KEYEV_TEXT',
           'TICKIT_PEN_BG', 'TICKIT_PENTYPE_INT',
           'TICKIT_TERMCTL_ALTSCREEN', 'TICKIT_PEN_FG',
           'TICKIT_PEN_REVERSE', 'TICKIT_TERMCTL_ICON_TEXT',
           'TICKIT_MOUSEWHEEL_UP', 'TickitPen',
           'TICKIT_TERM_CURSORSHAPE_LEFT_BAR', 'TickitPenEventFn',
           'TICKIT_N_PEN_ATTRS', 'TICKIT_PEN_BOLD',
           'TICKIT_MOUSEEV_RELEASE', 'TICKIT_PEN_ALTFONT',
           'TickitTermCursorShape', 'TICKIT_TERM_CURSORSHAPE_BLOCK',
           'TICKIT_PENTYPE_BOOL', 'TICKIT_MOUSEWHEEL_DOWN',
           'TickitTermEventFn', 'TickitTerm', 'TICKIT_MOUSEEV_DRAG',
           'TICKIT_TERMCTL_TITLE_TEXT', 'TICKIT_TERMCTL_MOUSE',
