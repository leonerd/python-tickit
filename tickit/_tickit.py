...
__all__ = ['TICKIT_EV_CHANGE', 'TickitRect', 'TICKIT_EV_MOUSE',
           ...
           'TickitPenAttr', 'TICKIT_TERMCTL_CURSORVIS',
           'TICKIT_TERMCTL_CURSORBLINK', 'TickitStringPos',
           'TickitMouseEventType', 'TickitEventType',
           'TICKIT_KEYEV_KEY', 'TickitKeyEventType',
           'TICKIT_TERMCTL_CURSORSHAPE', 'TICKIT_EV_UNBIND',
           'TICKIT_PEN_UNDER', 'TICKIT_PENTYPE_COLOUR',
           'TickitPenAttrType', 'TICKIT_N_PEN_ATTRS',
           'TICKIT_MOUSEEV_WHEEL', 'TickitEvent', 'TICKIT_KEYEV_TEXT',
           'TICKIT_PEN_BG', 'TICKIT_PENTYPE_INT', 'TICKIT_PEN_STRIKE',
           'TICKIT_PEN_FG', 'TICKIT_PEN_REVERSE',
           'TICKIT_TERMCTL_ICON_TEXT', 'TICKIT_MOUSEWHEEL_UP',
           'TickitPen', 'TICKIT_TERM_CURSORSHAPE_LEFT_BAR',
           'TickitPenEventFn', 'TICKIT_TERMCTL_MOUSE',
           'TICKIT_EV_RESIZE', 'TICKIT_PEN_ALTFONT',
           'TickitTermCursorShape', 'TICKIT_PENTYPE_BOOL',
           'TICKIT_MOUSEWHEEL_DOWN', 'TickitTermEventFn',
           'TickitTerm', 'TICKIT_MOUSEEV_DRAG',
           'TICKIT_TERMCTL_TITLE_TEXT', 'TickitRectSet',
           'TICKIT_MOUSEEV_RELEASE', 'TickitTermCtl',
           'TICKIT_TERMCTL_ICONTITLE_TEXT', 'TICKIT_PEN_BOLD']
